...
[Learn more in Mobile Architecture →](mobile/architecture.md)
...
[Explore Content Generation →](generation/architecture.md)
...
[Explore Mobile App →](mobile/architecture.md)
...
4. Critical Files Reference - Entry points for code exploration (see Architecture docs above)

### For Content Generation Work

1. [Architecture](generation/architecture.md) - Setup, design, and first run
2. [Core Concepts](generation/core-concepts.md) - Exercise types and pipeline

### For Mobile App Work

1. [Mobile Architecture](mobile/architecture.md) - Environment setup and app architecture
...
- **Setting up development?** Both architecture pages above include setup and environment details
