...
import { getMostRecentUser, getUserSettings, getUserId, UserSettings } from '../services/UserService';
...
export const useUserData = () => {
  ...
  const loadUserData = useCallback(async () => {
    try {
      ...
      const effectiveLanguage = settings.language || reduxSettings.language || 'French';
      const effectiveDifficulty = settings.difficulty || reduxSettings.difficulty || 'Beginner';
