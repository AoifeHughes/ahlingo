...
class HomeScreen(BaseScreen):
    ...
    def setup_ui(self):
        ...
        toolbar = StandardToolbar(
            title="AHLingo",
            right_action=("cog", self.go_to_settings)
        )
    ...
    def calculate_buttons_height(self):
        ...
        button_height = dp(48)  # Standard button height
        spacing = dp(10)        # Space between buttons
        padding = dp(40)        # Total vertical padding (20 top + 20 bottom)
        num_buttons = 2         # Number of buttons
    ...
    def add_exercise_buttons(self, layout):
        ...
        conversation_button = StandardButton(
            ...
            on_release=self.go_to_conversation
        )
