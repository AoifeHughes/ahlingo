...
class ReviseMistakesScreen(BaseScreen):
    ...
    def setup_screen(self):
        ...
        table_container.padding = [dp(16), dp(16), dp(16), dp(16)]  # left, top, right, bottom
        ...
        if not self.dialog:
            self.dialog = MDDialog(
                ...
                buttons=[
                    ...
                    MDFlatButton(
                        text="Yes",
                        on_release=lambda x: self.start_exercise(exercise_type, exercise_id)
                    ),
                ],
            )
        self.dialog.open()
            ...
            if failed_attempts:
                ...
                row_data = [
                    (
                        ...
                        datetime.fromisoformat(attempt["attempt_date"]).strftime("%Y-%m-%d %H:%M")
                    )
