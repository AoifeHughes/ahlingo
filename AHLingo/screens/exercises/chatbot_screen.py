...
class ChatInputLayout(MDBoxLayout):
    ...
    def __init__(self, submit_callback, **kwargs):
        ...
        self.send_button = MDIconButton(
            icon="send",
            on_release=lambda x: self.submit_message()
        )
...
class ChatbotExerciseScreen(BaseExerciseScreen):
    ...
    def create_toolbar(self):
        ...
        reset_button = MDIconButton(
            icon="refresh",
            on_release=lambda x: self.reset_chat()
        )
    ...
    def initialize_chat(self):
        ...
        self.add_message("Bot", "Hello! What would you like to talk about?", is_right=False)
    ...
    def send_message(self, message):
        ...
        # Add user message
        self.add_message("You", message, is_right=True)
        
        # Add typing indicator
        self.add_message("Bot", "...", is_right=False)
        ...
        threading.Thread(
            target=self.get_bot_response_in_thread,
            args=(message,),
            daemon=True
        ).start()
    ...
    def handle_bot_response(self, response):
        ...
        # Add bot response
        self.add_message("Bot", response, is_right=False)
    ...
    def add_message(self, speaker, message, is_right=False):
