...
<PairsGameScreen>:
    MDBoxLayout:
        ...
        MDTopAppBar:
            ...
            right_action_items: [["refresh", lambda x: root.refresh_exercise()]]
...
class PairsGameScreen(MDScreen):
    """Pairs game screen for matching exercises."""
    ...
    def __init__(self, **kwargs):
        super(PairsGameScreen, self).__init__(**kwargs)
    ...
    def set_topic(self, topic_name):
        """Set the current topic and load pairs."""
    ...
    def go_back(self):
        ...
        # Go back to topic selection screen with a backward animation
        app = MDApp.get_running_app()
        app.root.transition = SlideTransition(direction='right')
        app.root.current = 'topic_selection'
