...
def test_ambiguous_exercise():
    ...
    print(f"Options: {ambiguous_exercise['correct_answer']}, {ambiguous_exercise['incorrect_1']}, {ambiguous_exercise['incorrect_2']}")
...
def test_unambiguous_exercise():
    ...
    print(f"Options: {unambiguous_exercise['correct_answer']}, {unambiguous_exercise['incorrect_1']}, {unambiguous_exercise['incorrect_2']}")
